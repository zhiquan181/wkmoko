...
<html>
  ...
  <body>
    ...
    <div class="admin_body">
  		<h4>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;系统用户&nbsp;&rsaquo;&rsaquo;&nbsp;新增系统用户</h4>
	  	<form action="auserInsert" method="post">
	  		<p><span>用户账号：</span><input type="text" class="input" name="auser.username" value=""/></p>
	  		<p><span>用户密码：</span><input type="text" class="input"  name="auser.password" value=""/></p>
	  		<p><span>用户性别：</span><input type="text" class="input" name="auser.sex" value=""/></p>
	  		<p><span>用户权重：</span><input type="text" class="input" name="auser.weight" value=""/></p>
