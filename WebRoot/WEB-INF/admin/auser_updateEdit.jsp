...
<html>
	...
	<style type="text/css">
		*{margin:0;padding:0;border:0;}
		...
		.admin_nav .admin_nav_m span a{color:#666;}
	 	...
	 	form p .input{display:inline-block;text-indent:1em;width:800px;height:40px;border:1px solid #aaa;outline:none;font-size: 16px;}
  ...
  <body>
    ...
    <div class="admin_body">
  		<h4>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;系统用户&nbsp;&rsaquo;&rsaquo;&nbsp;修改系统用户</h4>
	  	<form action="auserUpdate" method="post">
	  		<p><span>ID：</span><input type="text" class="input" name="auser.userid" value="${auser_update.userid}"  readonly="readonly"/></p>
	  		<p><span>用户账号：</span><input type="text" class="input" name="auser.username" value="${auser_update.username}"/></p>
	  		<p><span>用户密码：</span><input type="text" class="input"  name="auser.password" value="${auser_update.password}"/></p>
	  		<p><span>用户性别：</span><input type="text" class="input" name="auser.sex" value="${auser_update.sex}"/></p>
	  		<p><span>用户权重：</span><input type="text" class="input" name="auser.weight" value="${auser_update.weight}"/></p>
