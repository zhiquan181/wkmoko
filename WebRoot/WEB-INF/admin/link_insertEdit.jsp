...
<html>
  ...
  <body>
    ...
    <div class="admin_body">
  		<h4>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;友情链接&nbsp;&rsaquo;&rsaquo;&nbsp;新增友情链接</h4>
	  	<form action="linkInsert" method="post">
	  		<input type="hidden" class="input" name="editorid" value="${auser_active.userid}"/>
	  		<p><span>网站标题：</span><input type="text" class="input" name="link.title" value=""/></p>
	  		<p><span>网站域名：</span><input type="text" class="input"  name="link.domain" value=""/></p>
