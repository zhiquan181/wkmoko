...
<html>
  ...
  <body>
    ...
    <div class="admin_body">
  		<h4>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;企业会员&nbsp;&rsaquo;&rsaquo;&nbsp;新增企业会员</h4>
	  	<form action="companyInsert" method="post">
	  		<p><span>公司名称：</span><input type="text" class="input" name="company.comname" value="" required="required"/></p>
	  		<p><span>会员账号：</span><input type="text" class="input" name="company.username" value="" required="required"/></p>
	  		<p><span>会员密码：</span><input type="text" class="input"  name="company.password" value="" required="required"/></p>
	  		<p><span>用户手机：</span><input type="text" class="input" name="company.phone" maxlength="11" value="" required="required"/></p>
	  		<p><span>用户地址：</span><input type="text" class="input" name="company.address" value="" required="required"/></p>
