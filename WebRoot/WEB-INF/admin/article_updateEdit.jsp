...
<html>
  ...
  <body>
    ...
    <div class="admin_body">
  		<h4>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;新闻资讯&nbsp;&rsaquo;&rsaquo;&nbsp;修改新闻资讯</h4>
	  	<form action="articleUpdate" method="post">
	  		<p>系统用户ID：<input type="text" class="input" name="editorid" value="${auser_active.userid}" readonly="readonly"/></p>
	  		<p><span>ID：</span><input type="text" class="input" name="article.articleid" value="${article_update.articleid}" readonly="readonly"/></p>
	  		<p><span>文章标题：</span><input type="text" class="input" name="article.title" value="${article_update.title}"/></p>
	  		<p><span>文章内容：</span><textarea rows="15" class="textarea" name="article.content">${article_update.content}</textarea></p>
