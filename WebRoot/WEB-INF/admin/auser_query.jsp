  ...
  <body>
	...
	<div class="admin_body">
		<ul class="admin_ul">
			...
			<li><a href="auserListPaging?currentPage=1" class="active">系统用户</a></li>
			<li><a href="linkListPaging?currentPage=1">友情链接</a></li>
		</ul>
		<div class="admin_section">
			<div class="admin_section_box">
				<div class="admin_section_box_content">
					<p>后台中心&nbsp;&rsaquo;&rsaquo;&nbsp;系统用户（用户管理）</p>
					<div>
						<form action="auserQuery" method="get">
							<span>
								...
								<input class="insert" type="button" value="新增"	onclick="window.location.href='auserInsertEdit'"/>
							</span>
						</form>
					</div>
				    <table align="center" border="0" cellpadding="0" cellspacing="0">
						...
						<s:iterator value="#request['ausers']" var="a_user">
							<tr align="center" height="26px">
								...
								<td>${a_user.weight}</td>
								<td>
									<a class="update" href="auserUpdateEdit?userid=${a_user.userid}">修改</a>&nbsp;&nbsp;
									<a class="delete" href="auserDelete?userid=${a_user.userid}">删除</a>
								</td>
							</tr>
						</s:iterator>
				...
				<div class="paging_pager">
					<div class="paging_pager_bar">
						...
						<s:if test="#pager.hasFirst">
						  <a class="pager_commom" href="auserListPaging.action?currentPage=1">首页</a>
						</s:if>
						<s:else>
						...
						<s:if test="#pager.hasPrevious">
							<a class="pager_commom" href="auserListPaging.action?currentPage=<s:property value="#pager.currentPage-1"/>">&lsaquo;</a>
						</s:if>
						<s:else>
						...
						<!-- 当前页 -->
						<a class="pager_commom" href="auserListPaging.action?currentPage=<s:property value="#pager.currentPage"/>"><s:property value="#pager.currentPage"/></a>
						
						<!-- 下一页 -->
						<s:if test="#pager.hasNext">
						  <a class="pager_commom" href="auserListPaging.action?currentPage=<s:property value="#pager.currentPage+1"/>">&rsaquo;</a>
						</s:if>
						<s:else>
						...
						<s:if test="#pager.hasLast">
						  <a class="pager_commom" href="auserListPaging.action?currentPage=<s:property value="#pager.totalPage"/>">尾页</a>
						</s:if>
						<s:else>
