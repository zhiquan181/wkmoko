				...
				<div class="paging_pager">
					<div class="paging_pager_bar">
						...
						<s:if test="#pager.hasFirst">
						  <a class="pager_commom" href="articleListPaging.action?currentPage=1">首页</a>
						</s:if>
						<s:else>
						...
						<s:if test="#pager.hasPrevious">
							<a class="pager_commom" href="articleListPaging.action?currentPage=<s:property value="#pager.currentPage-1"/>">&lsaquo;</a>
						</s:if>
						<s:else>
						...
						<!-- 当前页 -->
						<a class="pager_commom" href="articleListPaging.action?currentPage=<s:property value="#pager.currentPage"/>"><s:property value="#pager.currentPage"/></a>
						
						<!-- 下一页 -->
						<s:if test="#pager.hasNext">
						  <a class="pager_commom" href="articleListPaging.action?currentPage=<s:property value="#pager.currentPage+1"/>">&rsaquo;</a>
						</s:if>
						<s:else>
						...
						<s:if test="#pager.hasLast">
						  <a class="pager_commom" href="articleListPaging.action?currentPage=<s:property value="#pager.totalPage"/>">尾页</a>
						</s:if>
						<s:else>
